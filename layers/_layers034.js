...
postEvents: function() {
var s=j.getScrollBarWidth(),
r=this.position === "right",
q=this.namespace,
t=this.basename,
u=q === "addthis"&&t === "whatsnext",
m=q === "addthis"&&t === "recommendedside",
p=this.openControl,
n=this.element;
if (j.isNumber(s)&&s > 0) {
if (j.isElement(p)) {
if (r) {
j.setCSSAttr(p, "padding-right", s + "px");
} else {
if (r || u) {
j.setCSSAttr(p, "right", s + "px");
}
}
}
if (_ate.bro.ie10&&j.isElement(n)&&!m) {
if (r || u) {
j.setCSSAttr(n, "right", s + "px");
}
}
}
},
...
h.body.appendChild(f.json2html(p));
w["#at4-drawer-outer-container" + n + q]="";
...
"addthis.layers.drawer.show": function(p, n) {
this.showdrawer();
}
},
showdrawer: function() {
